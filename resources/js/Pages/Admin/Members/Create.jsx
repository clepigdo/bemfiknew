    ...
    return (
        <div className="min-h-screen bg-slate-900 text-white p-6 md:p-10">
            ...
            <div className="max-w-4xl mx-auto mb-8">
                ...
                <h1 className="text-3xl font-black tracking-tight">Tambah Pengurus Baru</h1>
                <p className="text-slate-400">Lengkapi formulir di bawah ini untuk menambahkan anggota BEM.</p>
            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="md:col-span-1">
                            ...
                            <div className="relative group">
                                {/* Area Preview / Upload */}
                                <div className={`aspect-[3/4] rounded-2xl border-2 border-dashed flex flex-col items-center justify-center relative overflow-hidden transition-all ${errors.photo ? 'border-red-500 bg-red-500/10' : 'border-slate-600 bg-slate-900/50 hover:border-blue-500 hover:bg-slate-900'}`}>
                                    ...
                                    {previewUrl ? (
                                        ...
                                        <div className="text-center p-6 cursor-pointer" onClick={() => document.getElementById('fileInput').click()}>
                                            ...
                                            <p className="text-sm font-medium text-slate-300">Klik untuk upload</p>
                        ...
                        <div className="md:col-span-2 space-y-6">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <div>
                                    <label className="block text-sm font-bold text-slate-300 mb-2">Jabatan</label>
                                    <input 
                                        type="text"
                                        value={data.position}
                                ...
                                <div>
                                    <label className="block text-sm font-bold text-slate-300 mb-2">Divisi</label>
                                    <select 
                                        value={data.division}
                                    ...
                                    >
                                        ...
                                        <option value="Medkref">Medkref</option>
                                        <option value="Mikat">Minat Bakat</option>
                                        <option value="Ekokraf">Ekokraf</option>
                            ...
                            {/* Status */}
                            <div>
                                <label className="block text-sm font-bold text-slate-300 mb-2">Status Keaktifan</label>
                                <div className="flex gap-4">
                                    <label className="flex items-center gap-2 cursor-pointer group">
                                        ...
                                        />
                                        <span className="text-slate-300 group-hover:text-white">Aktif</span>
                                    </label>
                                    <label className="flex items-center gap-2 cursor-pointer group">
                                        <input 
                                            type="radio" 
                                            ...
                                            className="w-5 h-5 text-blue-600 focus:ring-blue-500 bg-slate-900 border-slate-600"
                                        />
                                        <span className="text-slate-300 group-hover:text-white">Nonaktif / Alumni</span>
                                    </label>
                                </div>
                            </div>
