...
import {
    ArrowRight,
    CheckCircle2,
    Palette, // Ikon untuk Desain/Imaginate
    Camera, // Ikon untuk Fotografi/Video
    MonitorPlay, // Ikon untuk Konten Video/Micro Content
    Share2, // Ikon untuk Social Media
    Film, // Ikon untuk TikTok/Video Kreatif
    Sparkles,
    Zap,
    Instagram,
    Linkedin,
    PenTool, // Ikon untuk Kreativitas
...
export default function MedkrefPage() {
    ...
    const focusPoints = [
        {
            title: "Visual Design",
            subtitle: "Creative Aesthetics",
            desc: "Menciptakan identitas visual yang kuat dan estetik untuk seluruh publikasi BEM FIK.",
            icon: Palette,
        ...
        },
        {
            ...
            desc: "Memproduksi konten video dan grafis yang informatif, edukatif, dan menghibur.",
            icon: Camera,
        ...
        {
            title: "Information",
            subtitle: "Social Media Mgmt",
            desc: "Mengelola arus informasi di media sosial agar tersampaikan secara efektif kepada mahasiswa.",
            icon: Share2,
    ...
    // --- PROGRAM KERJA MEDKREF (SESUAI REQUEST) ---
    const prokerList = [
        {
            title: "SOCIAL MEDIA MANAGEMENT",
            desc: "Realisasi pengelolaan terpusat seluruh kanal media sosial BEM FIK. Mencakup perencanaan konten (content plan), publikasi hari besar/ulang tahun, dan menjaga estetika feeds.",
            image: "https://images.unsplash.com/photo-1611162617474-5b21e879e113?q=80&w=1000&auto=format&fit=crop", // Gambar HP/Sosmed
            points: [
                "Content Planning & Scheduling",
                "Birthday & Holiday Posts",
                "Feed Maintenance",
            ],
            tag: "Branding",
        ...
        {
            title: "IMAGINATE",
            desc: "Bootcamp pelatihan desain grafis dan publikasi media. Dilaksanakan dalam 3 pertemuan untuk meningkatkan skill anggota BEM dan mahasiswa umum FIK.",
            image: "https://images.unsplash.com/photo-1626785774573-4b799314346d?q=80&w=1000&auto=format&fit=crop", // Gambar Software Desain
            points: [
                "Pelatihan Desain Grafis",
                "3x Sesi Pertemuan",
                "Terbuka untuk Mahasiswa FIK",
            ],
            tag: "Education",
        ...
        {
            title: "MICRO CONTENT",
            desc: "Produksi konten video berkonsep formal/semi-formal yang membahas pengetahuan menarik dan tren terkini untuk diupload di berbagai platform BEM FIK.",
            image: "https://images.unsplash.com/photo-1574717432707-c25c8587a3ea?q=80&w=1000&auto=format&fit=crop", // Gambar Video Editing/Camera
            points: [
                "Video Edukasi & Tren",
                "Konsep Formal/Semi-Formal",
        ...
        },
        {
            ...
            desc: "Pembuatan konten video kreatif dan catchy mengikuti tren TikTok. Berkolaborasi dengan PR dan MIKAT untuk meningkatkan engagement dan branding BEM FIK.",
            image: "https://images.unsplash.com/photo-1611605698335-8b15f5c2db0e?q=80&w=1000&auto=format&fit=crop", // Gambar TikTok Icon/Ringlight
            points: [
                "Trend Based Content",
                "Kolaborasi PR & MIKAT",
                "Boost Engagement",
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-indigo-50/30 to-pink-50/20">
            <Head title="Profil MEDKREF - BEM FIK" />
            <Navbar />

            <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
                <div className="absolute top-20 left-10 w-72 h-72 bg-indigo-400/10 rounded-full blur-3xl animate-pulse"></div>
                <div
                    className="absolute bottom-20 right-10 w-96 h-96 bg-pink-400/10 rounded-full blur-3xl animate-pulse"
            ...
            <main className="relative w-full">
                <div className="relative w-full mb-20 overflow-hidden">
                    {/* Background Glow */}
                    <div className="absolute inset-0 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 blur-2xl opacity-20 animate-pulse"></div>

                    {/* --- HERO BACKGROUND --- */}
                    <div className="relative bg-gradient-to-br from-slate-900 via-indigo-900 to-purple-900 overflow-hidden shadow-2xl min-h-screen flex items-center">
                        <div className="absolute inset-0 opacity-30">
                            <div className="absolute inset-0 bg-gradient-to-tr from-indigo-500/20 via-transparent to-pink-500/20"></div>
                        </div>
                        ...
                        <div className="container mx-auto px-6 md:px-12 relative z-10 py-24 md:py-32 flex flex-col-reverse md:flex-row items-center justify-between gap-12">
                            ...
                            >
                                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-xl border border-white/20 mb-8">
                                    ...
                                    <span className="text-white/90 text-sm font-semibold">
                                        Divisi Media Kreatif & Informasi
                                    </span>
                                </div>
                                ...
                                <p className="text-indigo-100 text-xl max-w-xl leading-relaxed mb-10">
                                    Divisi Medkref adalah otak kreatif di balik
                                    wajah digital BEM FIK. Kami mengubah
                                    informasi menjadi visual yang memukau,
                                    mengelola media sosial, dan memproduksi
                                    konten kreatif yang relevan dengan semangat
                                    mahasiswa.
                                </p>
                            ...
                            >
                                <motion.div
                                    ...
                                    className="absolute inset-0 w-full h-full bg-gradient-to-tr from-indigo-500/30 via-purple-500/30 to-pink-500/30 rounded-full blur-[60px] -z-10"
                                ></motion.div>
                        ...
                        <div className="absolute -right-20 -bottom-20 w-80 h-80 bg-gradient-to-br from-indigo-500/30 to-pink-500/30 rounded-full blur-3xl"></div>
                    </div>
                </div>
                ...
                <div className="container mx-auto px-6 md:px-12 relative z-10">
                    ...
                    <div className="container mx-auto px-6 md:px-12 py-24">
                        ...
                        >
                            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[200px] h-[200px] bg-indigo-400/20 rounded-full blur-[80px] -z-10 group-hover:bg-pink-400/20 transition-colors duration-700"></div>

                            <motion.div
                                variants={scaleIn}
                                className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-white border border-indigo-100 shadow-sm mb-6 hover:shadow-md hover:scale-105 transition-all duration-300 cursor-default"
                            >
                            ...
                            <h2 className="text-5xl md:text-6xl font-black text-slate-900 mb-6 tracking-tight">
                                MEDKREF Kabinet{" "}
                                <span className="relative inline-block text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-pink-600">
                                    Sacakarsa
                                    <svg
                                        className="absolute w-full h-3 -bottom-2 left-0 text-indigo-400 opacity-60"
                                        viewBox="0 0 100 10"
                            ...
                            <p className="text-slate-600 text-lg md:text-xl mt-6 max-w-2xl mx-auto leading-relaxed">
                                Digerakkan oleh imajinasi tanpa batas, siap
                                menciptakan karya visual dan digital yang{" "}
                            ...
                            <div className="mt-8 flex justify-center">
                                <motion.div
                                    ...
                                    className="h-1.5 bg-gradient-to-r from-indigo-500 to-pink-500 rounded-full group-hover:w-48 transition-all duration-700 ease-out shadow-lg shadow-indigo-500/30"
                                ></motion.div>
                            </div>
                        </motion.div>
                        ...
                        >
                            {leaders.map((member, index) => (
                                <motion.div
                                    key={index}
                                    variants={fadeInUp}
                                    className="group relative h-[420px] w-full md:w-[320px] rounded-[2.5rem] overflow-hidden cursor-pointer shadow-2xl hover:shadow-indigo-500/30 transition-all duration-500 hover:-translate-y-3 ring-4 ring-white border-2 border-indigo-100"
                                >
                                    ...
                                    />
                                    <div className="absolute inset-0 bg-gradient-to-t from-indigo-950 via-purple-900/40 to-transparent opacity-80 group-hover:opacity-95 transition-opacity duration-300"></div>
                                    ...
                                    >
                                        ...
                                        <div className="absolute inset-0 flex flex-col justify-end p-6">
                                            <div className="transform translate-y-6 group-hover:translate-y-0 transition-transform duration-500">
                                                ...
                                                <div className="w-10 h-0.5 bg-indigo-500 mb-3 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    ...
                    <div className="mb-24 overflow-hidden">
                        ...
                        >
                            <motion.div
                                variants={scaleIn}
                                className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-indigo-100 to-pink-100 mb-4"
                            >
                                <Sparkles
                                    size={16}
                    ...
                    <div className="relative">
                        <div className="absolute inset-0 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 rounded-[3rem] blur-2xl opacity-30"></div>

                        <div className="relative bg-gradient-to-br from-slate-900 via-indigo-900 to-purple-900 rounded-[3rem] overflow-hidden shadow-2xl">
                            ...
                            <div className="relative z-10 p-12 md:p-20 text-center">
                                ...
                                <p className="text-indigo-100 text-lg mb-10 max-w-2xl mx-auto leading-relaxed">
                                    Mari wujudkan imajinasimu menjadi karya
                                    visual yang berdampak bersama Divisi MEDKREF
                                    BEM FIK UDINUS.
                                </p>
                            ...
                            <div className="absolute -left-20 -top-20 w-80 h-80 bg-gradient-to-br from-indigo-500/30 to-transparent rounded-full blur-3xl"></div>
                            <div className="absolute -right-20 -bottom-20 w-80 h-80 bg-gradient-to-br from-pink-500/30 to-transparent rounded-full blur-3xl"></div>
                        </div>
                    </div>
                </div>
            </main>
